/**
 * templates.js — Template definitions for Batch Mode (rendered by CanvasEngine).
 *
 * Each template defines: background, photo area, frame, text positions, logo position.
 * Restored from git history (it was deleted with the old Composer page in 5e9d5c7, but
 * Batch Mode still depends on it). Fonts are mapped to the brand fonts index.html loads
 * (Cormorant Garamond, Jost); the originals (Playfair, Montserrat, Inter) never loaded.
 * Square "post" templates are proportional, so they also serve the 4:5 portrait format.
 */
...
const ELARIS_TEMPLATES = {
    ...
    'dark-hero': {
        ...
        vignette: 0.25,
        defaultText: [
            { id: 'title', text: '', x: 0.5, y: 0.88, size: 34, fontFamily: "'Cormorant Garamond', serif", weight: '500', color: '#F0ECE6' },
            { id: 'subtitle', text: '', x: 0.5, y: 0.94, size: 12, fontFamily: "'Jost', sans-serif", weight: '400', color: '#A67C52', letterSpacing: 3 },
        ],
    ...
    'clean-light': {
        ...
        vignette: 0,
        defaultText: [
            { id: 'title', text: '', x: 0.5, y: 0.87, size: 31, fontFamily: "'Cormorant Garamond', serif", weight: '500', color: '#171717', shadow: false },
            { id: 'subtitle', text: '', x: 0.5, y: 0.93, size: 11, fontFamily: "'Jost', sans-serif", weight: '500', color: '#59704A', letterSpacing: 2, shadow: false },
        ],
    ...
    'heritage-warm': {
        ...
        vignette: 0.35,
        defaultText: [
            { id: 'title', text: '', x: 0.5, y: 0.85, size: 36, fontFamily: "'Cormorant Garamond', serif", weight: '500', color: '#EEE6D3' },
    ...
    'split-editorial': {
        ...
        vignette: 0,
        defaultText: [
            { id: 'title', text: '', x: 0.775, y: 0.4, size: 38, fontFamily: "'Cormorant Garamond', serif", weight: '500', color: '#171717', maxWidth: 0.35, shadow: false },
            { id: 'subtitle', text: '925 Sterling Silver', x: 0.775, y: 0.55, size: 10, fontFamily: "'Jost', sans-serif", weight: '500', color: '#A67C52', letterSpacing: 3, shadow: false },
            { id: 'cta', text: 'Shop Now →', x: 0.775, y: 0.65, size: 13, fontFamily: "'Jost', sans-serif", weight: '500', color: '#36442D', shadow: false },
        ],
    ...
    'cedar-botanical': {
        ...
        vignette: 0.2,
        defaultText: [
            { id: 'title', text: '', x: 0.5, y: 0.86, size: 31, fontFamily: "'Cormorant Garamond', serif", weight: '500', color: '#EEE6D3' },
            { id: 'subtitle', text: '', x: 0.5, y: 0.93, size: 11, fontFamily: "'Jost', sans-serif", weight: '400', color: '#C0C0C0', letterSpacing: 2 },
        ],
    ...
    'story-announce': {
        ...
        vignette: 0.2,
        defaultText: [
            { id: 'badge', text: 'NEW', x: 0.5, y: 0.08, size: 14, fontFamily: "'Jost', sans-serif", weight: '500', color: '#A67C52', letterSpacing: 6 },
            { id: 'title', text: '', x: 0.5, y: 0.74, size: 41, fontFamily: "'Cormorant Garamond', serif", weight: '500', color: '#F0ECE6', maxWidth: 0.8 },
            { id: 'subtitle', text: '925 Sterling Silver', x: 0.5, y: 0.81, size: 12, fontFamily: "'Jost', sans-serif", weight: '400', color: '#A67C52', letterSpacing: 3 },
            { id: 'cta', text: 'Tap to discover ✦', x: 0.5, y: 0.92, size: 14, fontFamily: "'Jost', sans-serif", weight: '500', color: 'rgba(255,255,255,0.5)' },
        ],
    ...
    'story-promo': {
        ...
        vignette: 0,
        defaultText: [
            { id: 'promo', text: 'SPECIAL OFFER', x: 0.5, y: 0.1, size: 13, fontFamily: "'Jost', sans-serif", weight: '500', color: '#A67C52', letterSpacing: 5 },
            { id: 'discount', text: '', x: 0.5, y: 0.7, size: 58, fontFamily: "'Cormorant Garamond', serif", weight: '500', color: '#F0ECE6' },
            { id: 'details', text: '', x: 0.5, y: 0.78, size: 14, fontFamily: "'Jost', sans-serif", weight: '400', color: '#A8A29E', maxWidth: 0.7 },
            { id: 'cta', text: 'DM to Order', x: 0.5, y: 0.9, size: 16, fontFamily: "'Jost', sans-serif", weight: '500', color: '#A67C52' },
        ],
        logo: { position: 'top-right', scale: 0.1, opacity: 0.5 },
        showHandle: true,
        previewColor: '#2a1f14',
    ...
    'story-sand': {
        ...
        vignette: 0,
        defaultText: [
            { id: 'title', text: '', x: 0.5, y: 0.73, size: 36, fontFamily: "'Cormorant Garamond', serif", weight: '500', color: '#171717', shadow: false, maxWidth: 0.7 },
            { id: 'subtitle', text: '', x: 0.5, y: 0.8, size: 11, fontFamily: "'Jost', sans-serif", weight: '500', color: '#59704A', letterSpacing: 2, shadow: false },
            { id: 'cta', text: 'Link in Bio', x: 0.5, y: 0.92, size: 14, fontFamily: "'Jost', sans-serif", weight: '500', color: '#36442D', shadow: false },
        ],
        logo: { position: 'top-right', scale: 0.1, opacity: 0.4 },
        showHandle: true,
        previewColor: '#EEE6D3',
...
/**
 * Get all templates, optionally filtered. 'portrait' (4:5) reuses the square layouts.
 */
function getTemplates(filter = {}) {
    let templates = Object.values(ELARIS_TEMPLATES);
    if (filter.format) {
        const fmt = filter.format === 'portrait' ? 'post' : filter.format;
        templates = templates.filter(t => t.format === fmt);
    }
 ...
 * `format` overrides the template's own shape (a square template previewed at 4:5).
 */
function renderTemplatePreview(template, canvas, size = 120, format = template.format) {
    const ratio = { story: 1920 / 1080, portrait: 1350 / 1080 }[format] || 1;
    canvas.width = size;
