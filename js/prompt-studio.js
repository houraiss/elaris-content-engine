...
const PromptStudio = {
    ...
    // ── Jewelry Categories ──────────────────────
    categories: ['ring','necklace','earrings','bracelet','bangles','anklet','brooch','pendant','body-jewelry','jewelry-set'],
    ...
    archetypes: [
        {
            ...
            compat: { ring: 95, necklace: 85, earrings: 90, bracelet: 70, bangles: 80, anklet: 50, brooch: 40, pendant: 75, 'body-jewelry': 60, watch: 85, 'jewelry-set': 70 },
        },
        {
            id: 'object-pairing',
            name: 'Object Pairing',
            ...
            compat: { ring: 90, necklace: 60, earrings: 50, bracelet: 65, bangles: 55, anklet: 45, brooch: 85, pendant: 80, 'body-jewelry': 30, watch: 80, 'jewelry-set': 85 },
        },
        {
            id: 'editorial-model',
            ...
            compat: { ring: 60, necklace: 95, earrings: 90, bracelet: 55, bangles: 60, anklet: 30, brooch: 65, pendant: 85, 'body-jewelry': 90, watch: 75, 'jewelry-set': 90 },
        },
        {
            id: 'surreal-animal',
            name: 'Surreal Animal',
            ...
            compat: { ring: 80, necklace: 50, earrings: 40, bracelet: 55, bangles: 50, anklet: 35, brooch: 85, pendant: 75, 'body-jewelry': 30, watch: 65, 'jewelry-set': 35 },
        },
        {
            id: 'gradient-product',
            ...
            compat: { ring: 90, necklace: 85, earrings: 80, bracelet: 85, bangles: 80, anklet: 70, brooch: 80, pendant: 90, 'body-jewelry': 50, watch: 90, 'jewelry-set': 80 },
        },
        {
            id: 'bw-dramatic',
            name: 'B&W Dramatic',
            ...
            compat: { ring: 85, necklace: 70, earrings: 80, bracelet: 75, bangles: 65, anklet: 45, brooch: 60, pendant: 70, 'body-jewelry': 60, watch: 80, 'jewelry-set': 75 },
        },
        {
            id: 'shadow-play',
            name: 'Shadow Play',
            ...
            compat: { ring: 85, necklace: 50, earrings: 40, bracelet: 80, bangles: 75, anklet: 70, brooch: 55, pendant: 55, 'body-jewelry': 35, watch: 85, 'jewelry-set': 60 },
        },
        {
            id: 'bold-typography',
            ...
            compat: { ring: 75, necklace: 80, earrings: 70, bracelet: 75, bangles: 70, anklet: 50, brooch: 80, pendant: 80, 'body-jewelry': 55, watch: 75, 'jewelry-set': 65 },
        },
        {
            ...
            compat: { ring: 70, necklace: 95, earrings: 90, bracelet: 85, bangles: 80, anklet: 40, brooch: 50, pendant: 80, 'body-jewelry': 65, watch: 70, 'jewelry-set': 98 },
        },
        {
            id: 'macro-detail',
            name: 'Macro Detail',
            ...
            compat: { ring: 95, necklace: 60, earrings: 70, bracelet: 65, bangles: 55, anklet: 50, brooch: 80, pendant: 75, 'body-jewelry': 40, watch: 90, 'jewelry-set': 40 },
        },
        {
            id: 'wet-element',
            name: 'Wet Element',
            ...
            compat: { ring: 90, necklace: 55, earrings: 50, bracelet: 80, bangles: 75, anklet: 60, brooch: 45, pendant: 70, 'body-jewelry': 35, watch: 85, 'jewelry-set': 45 },
        },
        {
            ...
            compat: { ring: 55, necklace: 90, earrings: 85, bracelet: 60, bangles: 65, anklet: 45, brooch: 50, pendant: 80, 'body-jewelry': 55, watch: 70, 'jewelry-set': 75 },
        },
        {
            id: 'flat-lay',
            ...
            compat: { ring: 80, necklace: 80, earrings: 80, bracelet: 80, bangles: 80, anklet: 70, brooch: 75, pendant: 80, 'body-jewelry': 45, watch: 85, 'jewelry-set': 95 },
        },
        {
            id: 'motion-blur',
            name: 'Motion & Flow',
        ...
        },
        {
            ...
            compat: { ring: 70, necklace: 90, earrings: 85, bracelet: 55, bangles: 50, anklet: 30, brooch: 45, pendant: 80, 'body-jewelry': 65, watch: 75, 'jewelry-set': 80 },
        },
        {
            ...
            compat: { ring: 90, necklace: 60, earrings: 75, bracelet: 55, bangles: 50, anklet: 40, brooch: 45, pendant: 80, 'body-jewelry': 30, watch: 85, 'jewelry-set': 65 },
        },
        {
            id: 'texture-contrast',
            ...
            compat: { ring: 80, necklace: 65, earrings: 60, bracelet: 80, bangles: 85, anklet: 70, brooch: 70, pendant: 75, 'body-jewelry': 40, watch: 85, 'jewelry-set': 75 },
        },
        {
            id: 'celestial-mythic',
            ...
            compat: { ring: 60, necklace: 95, earrings: 80, bracelet: 50, bangles: 55, anklet: 40, brooch: 70, pendant: 90, 'body-jewelry': 95, watch: 55, 'jewelry-set': 70 },
        },
        // ── NEW: Seasonal ──────────────────────
        {
            id: 'seasonal-holiday',
            ...
            compat: { ring: 90, necklace: 90, earrings: 85, bracelet: 85, bangles: 75, anklet: 60, brooch: 70, pendant: 90, 'body-jewelry': 50, watch: 85, 'jewelry-set': 95 },
        },
        // ── NEW: Lifestyle ──────────────────────
        {
            id: 'lifestyle-moment',
            ...
            compat: { ring: 95, necklace: 85, earrings: 80, bracelet: 95, bangles: 85, anklet: 50, brooch: 40, pendant: 75, 'body-jewelry': 35, watch: 95, 'jewelry-set': 80 },
        },
        // ── NEW: Nature/Botanical ──────────────────────
        {
            ...
            compat: { ring: 90, necklace: 80, earrings: 85, bracelet: 80, bangles: 70, anklet: 65, brooch: 75, pendant: 90, 'body-jewelry': 40, watch: 75, 'jewelry-set': 80 },
        },
        // ── NEW: Heritage/Moroccan ──────────────────────
        {
            ...
            compat: { ring: 85, necklace: 90, earrings: 80, bracelet: 85, bangles: 95, anklet: 80, brooch: 75, pendant: 85, 'body-jewelry': 70, watch: 70, 'jewelry-set': 85 },
        },
        // ── NEW: Minimalist ──────────────────────
        {
            id: 'minimalist-space',
        ...
        // ── NEW: Expansions ──────────────────────
        {
            ...
            compat: { ring: 60, necklace: 95, earrings: 85, bracelet: 70, bangles: 95, anklet: 50, brooch: 65, pendant: 80, 'body-jewelry': 85, watch: 65, 'jewelry-set': 65 },
        },
        {
            id: 'neon-cyberpunk',
            name: 'Neon Cyberpunk',
            ...
            compat: { ring: 95, necklace: 85, earrings: 70, bracelet: 90, bangles: 60, anklet: 40, brooch: 50, pendant: 85, 'body-jewelry': 55, watch: 80, 'jewelry-set': 50 },
        },
        {
            ...
            compat: { ring: 90, necklace: 70, earrings: 85, bracelet: 75, bangles: 60, anklet: 50, brooch: 40, pendant: 60, 'body-jewelry': 45, watch: 80, 'jewelry-set': 60 },
        },
        {
            id: 'zero-gravity',
            name: 'Zero Gravity',
            ...
            compat: { ring: 80, necklace: 60, earrings: 95, bracelet: 50, bangles: 65, anklet: 40, brooch: 75, pendant: 95, 'body-jewelry': 30, watch: 75, 'jewelry-set': 55 },
        },
        {
            id: 'surface-lean',
            name: 'Surface Lean',
            ...
            compat: { ring: 98, necklace: 60, earrings: 65, bracelet: 95, bangles: 90, anklet: 30, brooch: 50, pendant: 55, 'body-jewelry': 40, watch: 90, 'jewelry-set': 70 },
        },
        {
            id: 'hair-drama',
            name: 'Hair Drama',
            ...
            compat: { ring: 98, necklace: 50, earrings: 98, bracelet: 85, bangles: 80, anklet: 20, brooch: 30, pendant: 45, 'body-jewelry': 40, watch: 40, 'jewelry-set': 55 },
        },
        {
            ...
            compat: { ring: 95, necklace: 90, earrings: 50, bracelet: 95, bangles: 60, anklet: 30, brooch: 55, pendant: 85, 'body-jewelry': 50, watch: 95, 'jewelry-set': 65 },
        },
        {
            id: 'royal-opulence',
            name: 'Royal Opulence',
            ...
            compat: { ring: 85, necklace: 95, earrings: 90, bracelet: 80, bangles: 75, anklet: 30, brooch: 90, pendant: 85, 'body-jewelry': 40, watch: 80, 'jewelry-set': 90 },
        },
        // ── v3.0: From Reference Library ──────────────────────
        {
            ...
            compat: { ring: 60, necklace: 90, earrings: 85, bracelet: 80, bangles: 75, anklet: 70, brooch: 50, pendant: 85, 'body-jewelry': 65, watch: 70, 'jewelry-set': 70 },
        },
        {
            id: 'veiled-mystery',
            name: 'Veiled Mystery',
            ...
            compat: { ring: 80, necklace: 60, earrings: 98, bracelet: 40, bangles: 35, anklet: 20, brooch: 55, pendant: 75, 'body-jewelry': 45, watch: 45, 'jewelry-set': 45 },
        },
        {
            ...
            compat: { ring: 55, necklace: 70, earrings: 98, bracelet: 45, bangles: 40, anklet: 20, brooch: 90, pendant: 85, 'body-jewelry': 50, watch: 50, 'jewelry-set': 55 },
        },
        {
            ...
            compat: { ring: 80, necklace: 90, earrings: 85, bracelet: 80, bangles: 75, anklet: 50, brooch: 75, pendant: 90, 'body-jewelry': 60, watch: 75, 'jewelry-set': 75 },
        },
        {
            id: 'surreal-scale',
            name: 'Surreal Scale',
            ...
            compat: { ring: 50, necklace: 90, earrings: 85, bracelet: 55, bangles: 50, anklet: 30, brooch: 60, pendant: 85, 'body-jewelry': 70, watch: 60, 'jewelry-set': 55 },
        },
        {
            ...
            compat: { ring: 55, necklace: 85, earrings: 90, bracelet: 60, bangles: 55, anklet: 30, brooch: 40, pendant: 80, 'body-jewelry': 60, watch: 55, 'jewelry-set': 50 },
        },
        {
            ...
            compat: { ring: 90, necklace: 80, earrings: 30, bracelet: 98, bangles: 60, anklet: 20, brooch: 40, pendant: 75, 'body-jewelry': 55, watch: 95, 'jewelry-set': 65 },
        },
        {
            id: 'harsh-sun-beauty',
            ...
            compat: { ring: 70, necklace: 90, earrings: 95, bracelet: 80, bangles: 75, anklet: 60, brooch: 50, pendant: 85, 'body-jewelry': 65, watch: 75, 'jewelry-set': 65 },
        },
        {
            ...
            compat: { ring: 98, necklace: 98, earrings: 98, bracelet: 98, bangles: 98, anklet: 98, brooch: 98, pendant: 98, 'body-jewelry': 90, watch: 98, 'jewelry-set': 80 },
        },
        {
            id: 'textured-prop',
            ...
            compat: { ring: 90, necklace: 85, earrings: 95, bracelet: 90, bangles: 85, anklet: 70, brooch: 80, pendant: 85, 'body-jewelry': 60, watch: 85, 'jewelry-set': 85 },
        },
        {
            ...
            compat: { ring: 30, necklace: 95, earrings: 80, bracelet: 20, bangles: 15, anklet: 10, brooch: 40, pendant: 98, 'body-jewelry': 60, watch: 20, 'jewelry-set': 25 },
        },
        {
        ...
        // ── v3.3: From Sheet 15 Reference Analysis ──────────────────────
        {
            ...
            compat: { ring: 75, necklace: 90, earrings: 85, bracelet: 70, bangles: 60, anklet: 30, brooch: 50, pendant: 85, 'body-jewelry': 55, watch: 70, 'jewelry-set': 65 },
        },
        {
            id: 'micro-surreal',
            name: 'Micro Surreal',
            ...
            compat: { ring: 95, necklace: 40, earrings: 70, bracelet: 60, bangles: 50, anklet: 45, brooch: 90, pendant: 65, 'body-jewelry': 25, watch: 60, 'jewelry-set': 25 },
        },
        {
            ...
            compat: { ring: 98, necklace: 65, earrings: 40, bracelet: 95, bangles: 85, anklet: 25, brooch: 30, pendant: 55, 'body-jewelry': 30, watch: 95, 'jewelry-set': 55 },
        },
        // ── v3.4: From Sheets 8–10 Reference Analysis ──────────────────────
        {
            ...
            compat: { ring: 70, necklace: 90, earrings: 85, bracelet: 65, bangles: 55, anklet: 25, brooch: 60, pendant: 85, 'body-jewelry': 40, watch: 70, 'jewelry-set': 65 },
        },
        {
            id: 'prop-power-play',
            ...
            compat: { ring: 95, necklace: 55, earrings: 45, bracelet: 70, bangles: 50, anklet: 20, brooch: 90, pendant: 75, 'body-jewelry': 30, watch: 85, 'jewelry-set': 50 },
        },
        {
            id: 'skin-canvas',
            name: 'Skin Canvas',
            ...
            compat: { ring: 40, necklace: 70, earrings: 95, bracelet: 30, bangles: 25, anklet: 15, brooch: 55, pendant: 80, 'body-jewelry': 65, watch: 30, 'jewelry-set': 30 },
        },
        {
            id: 'reaching-gesture',
            ...
            compat: { ring: 98, necklace: 30, earrings: 35, bracelet: 95, bangles: 90, anklet: 15, brooch: 20, pendant: 25, 'body-jewelry': 30, watch: 90, 'jewelry-set': 50 },
        },
        ...
        },
        {
            ...
            compat: { ring: 98, necklace: 75, earrings: 80, bracelet: 98, bangles: 98, anklet: 40, brooch: 30, pendant: 60, 'body-jewelry': 50, watch: 60, 'jewelry-set': 92 },
        },
        {
            ...
            compat: { ring: 25, necklace: 75, earrings: 95, bracelet: 30, bangles: 20, anklet: 10, brooch: 85, pendant: 70, 'body-jewelry': 40, watch: 25, 'jewelry-set': 50 },
        },
        // ── v3.6: From Sheets 2, 4, 7, 20 Reference Analysis ──────────────────────
        {
            ...
            compat: { ring: 90, necklace: 85, earrings: 75, bracelet: 95, bangles: 80, anklet: 30, brooch: 65, pendant: 80, 'body-jewelry': 40, watch: 90, 'jewelry-set': 75 },
        },
        {
            ...
            compat: { ring: 90, necklace: 80, earrings: 98, bracelet: 75, bangles: 65, anklet: 40, brooch: 50, pendant: 70, 'body-jewelry': 55, watch: 70, 'jewelry-set': 70 },
        },
        {
            ...
            compat: { ring: 90, necklace: 85, earrings: 80, bracelet: 90, bangles: 70, anklet: 25, brooch: 60, pendant: 75, 'body-jewelry': 45, watch: 85, 'jewelry-set': 75 },
        },
        // ── NEW: Artisan at Work ──────────────────────
        {
            id: 'artisan-at-work',
            ...
            compat: { ring: 90, necklace: 85, earrings: 80, bracelet: 90, bangles: 95, anklet: 70, brooch: 85, pendant: 85, 'body-jewelry': 60, watch: 80, 'jewelry-set': 85 },
        },
        // ── NEW: Bridal / Trousseau ──────────────────────
        {
            ...
            compat: { ring: 80, necklace: 95, earrings: 95, bracelet: 90, bangles: 95, anklet: 75, brooch: 70, pendant: 90, 'body-jewelry': 55, watch: 55, 'jewelry-set': 98 },
        },
        // ── NEW: Souk / Market Editorial ──────────────────────
        {
            ...
            compat: { ring: 85, necklace: 90, earrings: 80, bracelet: 85, bangles: 90, anklet: 80, brooch: 75, pendant: 85, 'body-jewelry': 65, watch: 70, 'jewelry-set': 80 },
        },
        // ── NEW: Heirloom / Generational ──────────────────────
        {
            ...
            compat: { ring: 90, necklace: 95, earrings: 80, bracelet: 85, bangles: 95, anklet: 60, brooch: 80, pendant: 90, 'body-jewelry': 40, watch: 85, 'jewelry-set': 85 },
        },
        // ── NEW V2: Futuristic Chrome Editorial ──────────────────────
        {
            ...
            compat: { ring: 90, necklace: 85, earrings: 90, bracelet: 80, bangles: 65, anklet: 30, brooch: 70, pendant: 80, 'body-jewelry': 60, watch: 80, 'jewelry-set': 65 },
        },
        // ── NEW V2: Submerged Beauty ──────────────────────
        {
            ...
            compat: { ring: 80, necklace: 90, earrings: 95, bracelet: 70, bangles: 50, anklet: 40, brooch: 35, pendant: 85, 'body-jewelry': 55, watch: 65, 'jewelry-set': 50 },
        },
        // ── NEW V2: Surreal Material Fusion ──────────────────────
        {
            ...
            compat: { ring: 85, necklace: 70, earrings: 90, bracelet: 65, bangles: 50, anklet: 30, brooch: 85, pendant: 75, 'body-jewelry': 60, watch: 55, 'jewelry-set': 40 },
        },
        // ── NEW V2: Luxury Leather Editorial ──────────────────────
        {
            ...
            compat: { ring: 85, necklace: 90, earrings: 95, bracelet: 80, bangles: 60, anklet: 25, brooch: 75, pendant: 85, 'body-jewelry': 45, watch: 90, 'jewelry-set': 75 },
        },
        // ── NEW V2: Monochrome Jewelry Ad ──────────────────────
        {
            ...
            compat: { ring: 95, necklace: 90, earrings: 95, bracelet: 75, bangles: 55, anklet: 25, brooch: 70, pendant: 85, 'body-jewelry': 40, watch: 85, 'jewelry-set': 80 },
        },
        // ── NEW: Watch Category Archetypes ──────────────────────
        {
            ...
            compat: { ring: 30, necklace: 20, earrings: 20, bracelet: 60, bangles: 40, anklet: 10, brooch: 40, pendant: 20, 'body-jewelry': 10, watch: 95, 'jewelry-set': 10 },
        },
        {
            ...
            compat: { ring: 60, necklace: 50, earrings: 50, bracelet: 70, bangles: 50, anklet: 30, brooch: 30, pendant: 40, 'body-jewelry': 40, watch: 95, 'jewelry-set': 10 },
        },
        {
            ...
            compat: { ring: 70, necklace: 60, earrings: 70, bracelet: 75, bangles: 60, anklet: 20, brooch: 60, pendant: 50, 'body-jewelry': 50, watch: 95, 'jewelry-set': 10 },
        },
        {
            ...
            compat: { ring: 40, necklace: 30, earrings: 30, bracelet: 60, bangles: 50, anklet: 40, brooch: 20, pendant: 30, 'body-jewelry': 20, watch: 95, 'jewelry-set': 10 },
        },
        {
            ...
            compat: { ring: 30, necklace: 20, earrings: 20, bracelet: 40, bangles: 30, anklet: 10, brooch: 30, pendant: 20, 'body-jewelry': 10, watch: 95, 'jewelry-set': 10 },
        },
        // ── SET: Jewelry Set Archetypes ──────────────────────
        {
            id: 'set-editorial-display',
            name: 'Set Display',
            icon: '💫',
            tagline: 'The Complete Collection, Laid Bare',
            bestFor: 'Best for: Jewelry Sets — launch campaigns, collection reveals, gift guides',
            desc: 'Full set styled together on a surface — ring, necklace, and earrings arranged as a curated collection, editorial overhead or 45° angle',
            color: '#1f1a2e',
            subjects: [
                'matching {piece} set — ring, necklace, and earrings — arranged elegantly on dark navy velvet, gold tweezers and brand card as styling props, soft overhead editorial light',
                'complete {piece} jewelry set laid out on pale marble surface, all pieces in a beautiful triangular composition, natural side light casting soft shadows',
                '{piece} set — ring centered, necklace arched above it, earrings flanking symmetrically — on a white satin cushion, product editorial overhead angle',
                'full {piece} matching collection displayed on a hand-hammered silver tray, Moroccan texture visible beneath the pieces, warm studio lighting',
                '{piece} set arranged on a black velvet presentation board with minimalist brand typography, luxury campaign hero shot, angled 45° editorial',
                'collection of {piece} pieces — ring, necklace, earrings — grouped on raw linen fabric with scattered dried petals, lifestyle overhead styling',
            ],
            scene: 'clean editorial surface display, all set pieces visible simultaneously, soft even studio or natural window light, luxury product photography, no model — the set speaks entirely for itself, negative space framing, collection launch quality',
            compat: { ring: 50, necklace: 60, earrings: 50, bracelet: 55, bangles: 50, anklet: 40, brooch: 55, pendant: 55, 'body-jewelry': 30, watch: 30, 'jewelry-set': 100 },
        },
        {
            id: 'set-worn-collection',
            name: 'Set Worn Together',
            icon: '👑',
            tagline: 'Every Piece. One Moment.',
            bestFor: 'Best for: Jewelry Sets — editorial, bridal, campaign hero shots',
            desc: 'Model wearing all set pieces simultaneously — ring on finger, necklace at chest, earrings in ears — framed so every piece is visible in a single shot',
            color: '#1a1428',
            subjects: [
                'model with hand raised touching chin, {piece} ring on finger, necklace visible at décolletage, earrings catching light — all three set pieces simultaneously visible, editorial luxury',
                'model turning slightly to camera, {piece} earring prominent, necklace and ring both visible, soft smile, full jewelry set on display in one editorial frame',
                'model with both hands framing face, {piece} ring on each gesture hand, necklace at chest, earrings visible — maximum set display in a single portrait',
                'three-quarter portrait of model, {piece} necklace as anchor, earrings and ring both in the frame, editorial campaign composition showing the full set coherently',
                'close-medium crop of model chest and hands, {piece} ring and necklace both in sharp focus, earrings visible at frame edges, all pieces reading as a unified collection',
                'model looking slightly down, all {piece} set pieces visible — the editorial angle chosen specifically to frame ring, necklace, and earrings in one beautiful shot',
            ],
            scene: 'editorial portrait styled to show all set pieces simultaneously — the camera angle and pose deliberately chosen to frame ring, necklace, and earrings in a single shot, soft neutral or stone backdrop, black or jewel-tone clothing, 85mm lens shallow depth of field, warm studio or golden-hour light',
            compat: { ring: 60, necklace: 70, earrings: 65, bracelet: 55, bangles: 50, anklet: 30, brooch: 40, pendant: 65, 'body-jewelry': 40, watch: 30, 'jewelry-set': 98 },
        },
        {
            id: 'set-gift-presentation',
            name: 'Set Gift Moment',
            icon: '🎁',
            tagline: 'The Gift That Says Everything',
            bestFor: 'Best for: Jewelry Sets — gifting campaigns, seasonal, e-commerce',
            desc: 'The complete set presented as a gift — in a luxury jewelry box, on a satin cushion, wrapped with ribbon — the unboxing moment as luxury content',
            color: '#1f1520',
            subjects: [
                'open luxury jewelry box revealing complete {piece} set — ring, necklace, and earrings — nestled in white satin compartments, warm soft light casting a gentle glow',
                '{piece} set arranged in a dark velvet ring box and open necklace case, rose petals scattered around, soft romantic lighting, Valentine\u2019s or anniversary gift context',
                'hands opening a sleek black box to reveal the complete {piece} collection, each piece in its own compartment, editorial unboxing moment, soft warm backlight',
                'complete {piece} set displayed on a cream satin gift cushion with a ribbon bow, brand gift card leaning against it, luxury boutique presentation aesthetic',
                '{piece} ring, necklace, and earrings arranged in an open leather-bound jewelry box with gold interior, cinematic warm light, heritage gift editorial',
                'aerial view of full {piece} set in individual velvet compartments of an open gift box, minimalist flat-lay styling, white and gold color scheme, luxury gifting photography',
            ],
            scene: 'luxury gift presentation context, jewelry boxes and satin cushions, rose petals or ribbon as seasonal props, soft warm romantic or elegant lighting, aspirational gifting campaign photography, the set as the ultimate gift, editorial product styling',
            compat: { ring: 65, necklace: 70, earrings: 65, bracelet: 65, bangles: 55, anklet: 45, brooch: 55, pendant: 65, 'body-jewelry': 30, watch: 50, 'jewelry-set': 96 },
        },
        {
            id: 'set-detail-showcase',
            name: 'Set Piece Details',
            icon: '🔍',
            tagline: 'One Set. Three Close-Ups.',
            bestFor: 'Best for: Jewelry Sets — product pages, detail shots, craftsmanship stories',
            desc: 'Close-up showcase of each set piece individually but styled to read as a unified collection — ring macro, earring macro, necklace macro — the craftsmanship story of the full set',
            color: '#22201a',
            subjects: [
                'extreme macro of {piece} ring showing stone setting detail, with necklace and earring softly blurred behind — the set\u2019s craftsmanship story told through depth of field',
                'tight editorial macro of {piece} necklace pendant clasp and chain detail, matching ring visible on surface behind, earring in soft focus — unified collection macro',
                'close-up of {piece} earring catch and post detail, necklace chain artfully arranged around it, ring resting nearby — all pieces reading as one set in one macro frame',
                'product macro showing all three {piece} set pieces on dark velvet — ring sharpest, necklace slightly softer, earrings at the periphery — depth suggesting the full collection',
                'extreme close-up of stone facets on {piece} ring, the necklace with matching stones softly present in background, editorial macro craftsmanship detail',
                'artisan\u2019s hands presenting all three {piece} set pieces at once — ring on one finger, earring held between thumb and index, necklace draped over palm — craftsmanship reveal',
            ],
            scene: 'macro product photography, 100mm macro lens, razor-sharp focus on individual piece details, other set pieces visible in soft bokeh background to establish collection unity, studio ring light or soft box, dark or neutral backdrop, craftsmanship storytelling aesthetic, luxury jewelry close-up quality',
            compat: { ring: 70, necklace: 70, earrings: 70, bracelet: 55, bangles: 50, anklet: 40, brooch: 65, pendant: 65, 'body-jewelry': 30, watch: 35, 'jewelry-set': 95 },
        },
    ...
    _getAnglesForCategory(category) {
        const rankings = {
            ...
            // Jewelry Set: eye-level and 45° show multiple worn pieces; flat-lay is ideal for display
            'jewelry-set': [
                'eye-level', '45-degree', 'flat-lay', 'glance-down', 'overhead',
                'from-behind', 'golden-hour', 'chin-up', 'macro', 'through-glass',
                'over-shoulder', 'side-profile', 'candid', 'tilt-shift', 'foreground-blur',
                'low-angle', 'dutch', 'extreme-macro', 'knuckle-level', 'top-down-hand',
                'silhouette', 'worms-eye',
            ],
    ...
    state: {
        ...
        pieceDesc: '',
        category: 'ring',
            setComposition: ['ring', 'necklace', 'earrings'],  // sub-pieces in the jewelry set
    ...
    _autoDescribe() {
        ...
        const templates = {
            ...
            'jewelry-set': (() => {
                ...
                const pieceLabels = { ring: 'ring', necklace: 'necklace', earrings: 'earrings', bracelet: 'bracelet', bangle: 'bangle' };
                const pieces = comp.map(p => pieceLabels[p] || p);
                const piecesStr = pieces.length > 1
                    ? pieces.slice(0, -1).join(', ') + ', and ' + pieces[pieces.length - 1]
                    : (pieces[0] || 'ring, necklace, and earrings');
                return `matching ${mat.toLowerCase()} jewelry set — ${piecesStr}${stoneText}`;
            })(),
        };
    ...
    // Toggle a piece in/out of setComposition
    _toggleSetPiece(pieceId) {
        const comp = [...(this.state.setComposition || ['ring', 'necklace', 'earrings'])];
